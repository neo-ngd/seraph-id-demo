                    ...
                    <div className="PageActions">
                        ...
                        {resetClicked ? (
                            <Fab variant="extended" className="RightButton">
                                ...
                                <Fab onClick={onResetClicked} variant="extended" color="primary" className="RightButton">
                                    Reset
                                    </Fab>
                            )}
                    </div>
                        ...
                        <div className="PageActions">
                            <Tooltip title="Create another DID and restart from scratch">
                                <Link to="/dashboard" className="DashboardLink">
                                    <Fab variant="extended" color="primary" className="RightButton">
                                        Let's start
                                    </Fab>
                                </Link>
                            </Tooltip>
